...
Signal:
  - 'long'  — strong uptrend (EMA8>EMA21>EMA50, ADX>=35, EMA50 rising) + 3 consecutive green candles
  - 'short' — strong downtrend (EMA8<EMA21<EMA50, ADX>=35, EMA50 falling) + 3 consecutive red candles
  - 'none'  otherwise
"""
...
#             and ema_sep_ok_cross                    # Filter fake micro-crosses
        ...
        ema_stack_up   = ema_fast > ema_slow > ema_trend
        ema_stack_down = ema_fast < ema_slow < ema_trend
        ...
        # ── 2. Dip & Rip continuation (disabled) ─────────────────────────────
